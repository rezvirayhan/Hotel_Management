    ...
    return (
      ...
      <Row>
        ...
        <small>SOCIAL MEDIA CHANNELS</small>
            ...
            <div className='mr-3 mt-3 '>
                <img className='mr-2' style={{width:'10%'}} src={world} alt="" />
                <img className='mr-2' style={{width:'10%'}} src={facebook} alt="" />
                <img className='mr-2' style={{width:'10%'}} src={instagram} alt="" />
                <img className='mr-2' style={{width:'10%'}} src={linkedin} alt="" />
                <img className='mr-2' style={{width:'10%'}} src={youtube} alt="" />
                <img className='mr-2' style={{width:'10%'}} src={twitter} alt="" />
      ...
      <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Control type="email" placeholder="Your Email" />
           ...
           <center>
           © Developed By <a href="https://www.linkedin.com/in/devrezvirayhan/"><b>Rezvi Rayhan</b></a> 
           </center>
            </div>
        </div>
    );
